...
@section('page-header')
<!-- breadcrumb -->
<h4 style="color: blue"> اضافة سلوك الطالب
</h4>
@section('PageTitle')
    اضافة سلوك الطالب
@stop
    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <form method="post" action="{{ route('dashboard.behaviors.store') }}" autocomplete="off"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select mr-sm-3" name="type">
                                    ...
                                    <option value="positive" style="background-color: green">إيجابي</option>
                                    <option value="negative" style="background-color: rgb(233, 78, 6)">سلبي</option>
                                </select>
                            </div>
                        </div>
